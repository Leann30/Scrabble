...
constructor(boardCanvas, bottomCanvas, topCanvas, endpoint) {
    ...
    this.fieldWidthPlayerTop = this.topCanvas.width / 15;
    this.fieldHeightPlayerTop = this.topCanvas.height / 15;
    this.squareSizePlayerTop = this.topCanvas.width / this.gridSize;
    ...
    this.fieldWidthPlayerBottom = this.bottomCanvas.width / 15;
    this.fieldHeightPlayerBottom = this.bottomCanvas.height / 15;
    this.squareSizePlayerBottom = this.bottomCanvas.width / this.gridSize;
    ...
    drawTilesTop(){
        for(let i = 0; i < 7; i++){
            ...
            this.ctxTop.fillRect(i * this.squareSizePlayerTop+4, (2*this.squareSizePlayerTop)-4, this.squareSizePlayerTop, this.squareSizePlayerTop);
            this.ctxTop.strokeStyle = "black"; 
            this.ctxTop.lineWidth = 2; 
            this.ctxTop.strokeRect(i * this.squareSizePlayerTop+4, (2*this.squareSizePlayerTop)-4, this.squareSizePlayerTop, this.squareSizePlayerTop);
        }
    }
    ...
    drawTilesBottom(){
        for(let i = 0; i < 7; i++){
            ...
            this.ctxBottom.fillRect(i * this.squareSizePlayerBottom+4, 4, this.squareSizePlayerBottom, this.squareSizePlayerBottom);
            this.ctxBottom.strokeStyle = "black"; 
            this.ctxBottom.lineWidth = 2; 
            this.ctxBottom.strokeRect(i * this.squareSizePlayerBottom+4, 4, this.squareSizePlayerBottom, this.squareSizePlayerBottom);
        }
    }
